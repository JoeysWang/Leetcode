...
1. [回溯：Subsets](#1-回溯subsets)
2. [回溯：Subsets With Dup](#2-回溯subsets-with-dup)
3. [回溯：Combinations](#3-回溯combinations)
4. [回溯：Permutations](#4-回溯permutations)
5. [回溯：Combination Sum](#5-回溯combination-sum)
6. [回溯：Solve Sudoku](#6-回溯solve-sudoku)
7. [回溯：Generate Parenthesis](#7-回溯generate-parenthesis)
8. [滑动窗口：Longest Substring Without Repeating](#8-滑动窗口longest-substring-without-repeating)
9. [滑动窗口：Minimum Window Substring](#9-滑动窗口minimum-window-substring)
10. [滑动窗口：Find Anagrams](#10-滑动窗口find-anagrams)
11. [滑动窗口：Check Inclusion](#11-滑动窗口check-inclusion)
12. [双指针：Two Sum](#12-双指针two-sum)
13. [双指针：Three Sum](#13-双指针three-sum)
14. [双指针：Four Sum](#14-双指针four-sum)
15. [位运算：Single Number](#15-位运算single-number)
16. [位运算：Hamming Weight](#16-位运算hamming-weight)
17. [位运算：Count Bits](#17-位运算count-bits)
18. [栈：Basic Calculator](#18-栈basic-calculator)
19. [栈：Evaluate Reverse Polish Notation](#19-栈evaluate-reverse-polish-notation)
20. [ Pancake Sorting](#20-pancake-sorting)
21. [前缀和：Range Sum Query 1D](#21-前缀和range-sum-query-1d)
22. [前缀和：Range Sum Query 2D](#22-前缀和range-sum-query-2d)
23. [前缀和：Subarray Sum Equals K](#23-前缀和subarray-sum-equals-k)
24. [大数运算：Multiply Strings](#24-大数运算multiply-strings)
25. [大数运算：Add Strings](#25-大数运算add-strings)
26. [DFS：Flood Fill](#26-dfsflood-fill)
27. [DFS：Number of Islands](#27-dfsnumber-of-islands)
28. [DFS：Max Area of Island](#28-dfsmax-area-of-island)
29. [DFS：Surrounded Regions](#29-dfssurrounded-regions)
30. [区间：Merge Intervals](#30-区间merge-intervals)
31. [区间：Insert Interval](#31-区间insert-interval)
32. [区间：Interval Intersection](#32-区间interval-intersection)
33. [随机：Shuffle an Array](#33-随机shuffle-an-array)
34. [随机：Linked List Random Node (水塘抽样)](#34-随机linked-list-random-node)
35. [链表：Reverse Linked List](#35-链表reverse-linked-list)
36. [二叉树：Maximum Depth](#36-二叉树maximum-depth)
37. [二叉树：Invert Binary Tree](#37-二叉树invert-binary-tree)
38. [二叉树：Maximum Path Sum](#38-二叉树maximum-path-sum)
...
private boolean isValidSudokuChoice(char[][] board, int row, int col, char ch) {
    for (int i = 0; i < 9; i++) {
        ...
        if (board[row][i] == ch || board[i][col] == ch || board[boxRow][boxCol] == ch) {
            return false;
        }
    }
    return true;
...
## 8. 滑动窗口：Longest Substring Without Repeating
...
## 9. 滑动窗口：Minimum Window Substring
...
## 19. 栈：Evaluate Reverse Polish Notation
